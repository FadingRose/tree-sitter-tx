...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [29] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_return, 4, 0, 0),
  ...
  [58] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(24),
  ...
  [73] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_trace_line, 2, 0, 0),
  [75] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_trace_line, 2, 0, 0),
  [77] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_trace_line, 3, 0, 0),
  [79] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_trace_line, 3, 0, 0),
  [81] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_number_value, 1, 0, 0),
  [83] = {.entry = {.count = 1, .reusable = true}}, SHIFT(54),
  [85] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_prefix, 1, 0, 0),
  [87] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_number_value, 2, 0, 0),
  [89] = {.entry = {.count = 1, .reusable = true}}, SHIFT(52),
  [91] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_argument_list_repeat1, 2, 0, 0),
  [93] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_argument_list_repeat1, 2, 0, 0), SHIFT_REPEAT(10),
  [96] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_key_value_pair, 3, 0, 3),
  [98] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_number_value, 10, 0, 0),
  ...
  [114] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_argument_list, 1, 0, 0),
  [116] = {.entry = {.count = 1, .reusable = true}}, SHIFT(10),
  [118] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_preamble_repeat1, 2, 0, 0),
  [120] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_preamble_repeat1, 2, 0, 0), SHIFT_REPEAT(66),
  [123] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_preamble, 4, 0, 0),
  [125] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_preamble, 4, 0, 0),
  [127] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_boolean, 1, 0, 0),
  [129] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_labeled_address, 5, 0, 0),
  [131] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_preamble, 5, 0, 0),
  [133] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_preamble, 5, 0, 0),
  [135] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_struct, 4, 0, 0),
  [137] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_argument_list, 2, 0, 0),
  [139] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_call, 6, 0, 0),
  [141] = {.entry = {.count = 1, .reusable = true}}, SHIFT(60),
  [143] = {.entry = {.count = 1, .reusable = true}}, SHIFT(6),
  [145] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_number_value, 7, 0, 0),
  [147] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_number_value, 6, 0, 0),
  [149] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_number_value, 8, 0, 0),
  [151] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_number_value, 9, 0, 0),
  [153] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_value_list, 1, 0, 0),
  [155] = {.entry = {.count = 1, .reusable = true}}, SHIFT(77),
  [157] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_value_list, 2, 0, 0),
  [159] = {.entry = {.count = 1, .reusable = true}}, SHIFT(95),
  [161] = {.entry = {.count = 1, .reusable = true}}, SHIFT(67),
  [163] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_call, 8, 0, 0),
  [165] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_call, 9, 0, 0),
  [167] = {.entry = {.count = 1, .reusable = true}}, SHIFT(62),
  [169] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_contract_path, 1, 0, 0),
  ...
  [187] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_event_repeat1, 2, 0, 5), SHIFT_REPEAT(62),
  [190] = {.entry = {.count = 1, .reusable = true}}, SHIFT(97),
  [192] = {.entry = {.count = 1, .reusable = true}}, SHIFT(98),
  [194] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_summary, 4, 0, 0),
  [196] = {.entry = {.count = 1, .reusable = true}}, SHIFT(101),
  [198] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_compiling_line, 4, 0, 0),
  ...
  [220] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__raw_event_body, 3, 0, 4),
  [222] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_event, 4, 0, 0),
  ...
  [232] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_return_type, 1, 0, 0),
  ...
  [242] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_return, 2, 0, 0),
  [244] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_return, 5, 0, 0),
  ...
  [254] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__raw_event_body, 4, 0, 6),
  [256] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_event, 5, 0, 0),
  [258] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_event_repeat1, 3, 0, 7),
  ...
  [266] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_gas, 1, 0, 0),
  ...
  [280] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_summary, 5, 0, 0),
  ...
  [288] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_call, 7, 0, 0),
  ...
  [300] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_contract_path, 5, 0, 0),
  ...
  [316] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_call_type, 3, 0, 0),
  ...
  [326] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_call, 10, 0, 0),
